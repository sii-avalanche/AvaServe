    ...
    if cfg.pp_size > 1:
        assert (
            ...
            and (
                ...
                or cfg.speculative_algorithm == "DSPARK"
            )
        ), "Pipeline parallelism is not compatible with overlap schedule; only DSPARK speculative decoding is supported with pp_size > 1"
