            ...
            for name, loaded_weight in weights:
                ...
                for param_name, weight_name, shard_id in stacked_params_mapping:
                    ...
                    for mapping in expert_params_mapping:
                        ...
                        if name.endswith(".bias") and name not in params_dict:
                            continue
                        # Skip loading embed_tokens where it is a PPMissingLayer
                        # (every PP rank but the first -- except a last stage
                        # that keeps a real, loaded copy to share with a
                        # DSpark draft; see keep_embed_for_dspark).
                        if ".embed_tokens." in name and isinstance(
